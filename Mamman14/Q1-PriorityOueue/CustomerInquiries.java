public class CustomerInquiries {
    ...
    public boolean equals(CustomerInquiries customerInquiries) {
        return customerId == customerInquiries.customerId && referenceDetails.equals(customerInquiries.referenceDetails);
    }
